...
class OrderBook:
    def view_orderbook() -> OrderBook | Any:
        ...
        Returns:
        OrderBook: A data structure (e.g., an object, a list, ... that allows readonly view of all pending limit orders.
        """
        pass
    ...
    def submit_order(
        ...
        order_type: One of "market", "limit", "fok" (fill-or-kill), "ioc"
        (immediate- or-cancel)
        side: "buy" or "sell"
